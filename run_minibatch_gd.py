...
for learning_rate in learning_rates:
    for l1, l2 in l1_l2:
        for batch_size in batch_sizes:
            ...
            model = SoftmaxRegressionSGD(num_classes= Y_val.shape[1], num_iterations = 1000, early_stop = 50, do_backtrack= True, learning_rate=learning_rate, batch_size = batch_size, lambda1 = l1, lambda2 = l2, do_one_hot= False, experiment_name=expriment_name)
